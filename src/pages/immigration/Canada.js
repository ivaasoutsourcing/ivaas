    ...
    <>
      ...
      <div className="container mt-5">
        <div className="html-text-box">
          <HeadingHtml heading={heading1} />
          <ParaHtml paras={para1} />
        </div>
        <div className="html-text-box">
          <SubHeadingHtml subHeading={subheading1} />
          <ParaHtml paras={subpara1} />
          <OrderHtml isOrder={false} orderList={subUnorderList1} />
          <ParaHtml paras={subpara2} />
        </div>
        <div className="html-text-box">
          <SubHeadingHtml subHeading={subheading2} />
          <ParaHtml paras={subpara3} />
        </div>
      </div>
    </>
  );
